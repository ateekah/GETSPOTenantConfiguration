#Install SPO Management sgell
#https://www.microsoft.com/en-us/download/details.aspx?id=35588
# You need SPO admin account and account that is not MFA enabled
...
#if MFA enabled the  run - Connect-SPOService -Url https://yourtenant-admin.sharepoint.com #-credential yourglobaladmin@yourtenant.onmicrosoft.com
